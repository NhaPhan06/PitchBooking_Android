package com.example.pitchbooking.activity.adapter.CurrentBooking;
...
public class CurrentBookingAdapter extends BaseAdapter {
    ...
    private CurrentBookingActivity context;
    private int layout;
    private ArrayList<Schedule> arr;

    public CurrentBookingAdapter(CurrentBookingActivity context, int layout, ArrayList<Schedule> arr) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        CurrentBookingAdapter.ViewHolder viewHolder = null;

        if (viewHolder == null) {
            viewHolder = new CurrentBookingAdapter.ViewHolder();
